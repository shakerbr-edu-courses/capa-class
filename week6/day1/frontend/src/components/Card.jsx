    ...
    return (
        <div className="font-medium text-white min-w-90 min-h-50 p-6 rounded-2xl bg-[#007fffcc] shadow-md shadow-blue-500/50 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
            ...
            <div className="flex flex-col">
                ...
                <div className="flex justify-between">
                    <p className="text-left ml-4">Likes:</p>
                    <p className="font-bold mr-4">{likes}</p>
                </div>
                <div className="flex flex-col mt-4 ">
                    <button className='px-12 py-2 bg-white text-[#007fff] font-black rounded-lg cursor-pointer transition-all duration-300 hover:-translate-y-1 hover:shadow-lg' onClick={(e) => { setLikes(likes + 1) }}>Like</button>
                </div>
            </div>
        </div>
    )
